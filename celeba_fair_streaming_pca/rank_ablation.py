...
def main(attr_name, dataset_train, dataset_val):
    ...
    for index in attr_false_list_val+attr_true_list_val:
        ...
        for i, r in enumerate(rank_list):
            ...
            if r == 0:
                ...
                if r == 'mean':
                    ...
                    axes[0][i].title.set_text(f'mean & Cov ({r})')     
        ...
        fig.tight_layout()
        fig.savefig(f'figures/{attr_name}_{ATTR[attr_name]}/RankAblation_all_{bool(label[pca.a])}_{index}.pdf')
        plt.close(fig)
    del pca
...
if __name__ == '__main__':
    ...
    #attr_list = "Eyeglasses Goatee Male Mustache Narrow_Eyes No_Beard Smiling Wearing_Hat Young Mouth_Slightly_Open"
    attr_list = "Bald Bangs Black_Hair Blond_Hair Brown_Hair"
